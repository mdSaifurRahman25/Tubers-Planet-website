...
export const metadata: Metadata = {
    title: "Verify Reset Code | Thumblify",

    description:
        "Verify the secure code sent to your email to continue resetting your Thumblify password.",
...
const VerifyPasswordResetOtpPage = () => {
    return (
        ...
        >
            ...
            <section
                aria-labelledby="password-reset-verification-title"
                className="
                    relative
                    z-10
                    flex
            ...
            >
                <h1
                    id="password-reset-verification-title"
                    className="sr-only"
                >
